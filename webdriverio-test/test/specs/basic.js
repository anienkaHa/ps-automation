...
const { selectDropDown} = require('../../utility-methods/infinite-scroll')
...
// describe('Test the infinite scroll on the internet app', () => {
//     it('should test', () => {
...
//         console.log(parentElement.getSize())

//         console.log(Math.round(Math.random() * 10))
//     });
// });

describe('Check the two different check boxes', () => {
    it('should check both check boxes random amount of times', () => {
